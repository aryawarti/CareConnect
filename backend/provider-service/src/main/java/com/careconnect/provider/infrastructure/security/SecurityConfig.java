    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Public doctor directory (FR-C3) — also allowlisted at the gateway
                        .requestMatchers("/api/providers/directory/**").permitAll()
                        // Department reference list — also allowlisted at the gateway (used
                        // by the demo seeder's readiness probe before any account exists).
                        .requestMatchers("/api/providers/departments").permitAll()
